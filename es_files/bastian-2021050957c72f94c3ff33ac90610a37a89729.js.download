...
n.r(t),n.d(t,"set",(function(){return d})),n.d(t,"get",(function(){return p})),n.d(t,"decr",(function(){return f})),n.d(t,"incr",(function(){return m})),n.d(t,"absorbConfigs",(function(){return v})),n.d(t,"Configs",(function(){return O}))
...
d("feedId",e.id||Object(a.get)(e,"items.0.feedId")||"unknown-feedId"),d("referer",e.referer),d("recommendationCounter",0),b(e),E(e),y(e),_(e)},b=e=>{const t="distributed-components",n="cards"
let r
...
d("recommendationStart",(!c.At.smallScreen||"uber"===p("headlineVariation"))&&t<=n?n+1:t)},_=e=>{const t=Object(a.get)(e,"config.strategies")
t&&t.includes("channels")?d("isSegmentedByChannels",!0):d("isSegmentedByChannels",!1)},y=e=>{const t=Object(a.get)(e,"config.recommendation.active")
d("isRecommended",l.Globals.BASTIAN_FORCE_RECOMMENDED||(i()(t)?u.Settings.get("IS_RECOMMENDED",!1):t))},O={set:d,has:e=>h.has(e),get:p,unset:e=>h.delete(e),clear:()=>h.clear(),decr:f,incr:m,absorbConfigs:v}
t.default=O},function(e,t){e.exports=function(e){return void 0===e}},function(e,t,n){"use strict"
n.r(t)
var r=n(26),i=n.n(r)
...
const e=this.getImageProps(),t=a.Engine.createElement("div",p({ref:Object(l.as)(this),onMouseUp:this.props.onMouseUp},this.getCoverProps()),a.Engine.createElement("picture",{className:"bstn-fd-cover-picture"},a.Engine.createElement("img",p({className:"bstn-fd-picture-image"},e,{loading:"lazy"}))),this.props.children)
...
Object(r.warn)("ViewportObserver :: setViewportObserver - requires observerName and callback")},s=(e,t)=>t&&window[e]&&window[e].observe(t),o=(e,t)=>t&&window[e]&&window[e].unobserve(t),a=()=>"IntersectionObserver"in window},function(e,t,n){const r="10.12.0".split(".")
...
return s=r&&a?o.Engine.createElement(P,k({onReveal:c},e),M(e)):o.Engine.createElement(x,k({onReveal:c},e),M(e)),s}
var H=n(23)
...
return{content:e,media:F(e),contentType:this.getContentType(),tenantId:Object(c.get)(this,"props.tenantId")}},this.state={title:this.isMabEnabled()?"":Object(c.get)(e,"content.title")}}render(){const e=v()("feed-post","bstn-item-shape",{["type-"+this.props.type]:this.props.type})
...
return o.Engine.createElement(U,{ref:Object(f.as)(this,F(Object(c.get)(this,"props.content"))),title:e,url:t,video:n,image:r,isEsppub:Object(he.has)(this,"props.pubeditorial"),postContentType:this.getContentType(),canShowVideoPreview:se(this.getPostContentData())})}Metadata(){let e
...
for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e}).apply(this,arguments)}const $e=e=>{const{extraClasses:t,image:n,description:r,thumbOrientation:i,url:a,title:c,children:l,ratio:u="1:1"}=e,h="bstn-fd-stories-cover "+(t||"")
let d
...
return n&&n.rightsholder&&(i.alt=n.rightsholder,i.title=n.rightsholder),h.Engine.createElement("a",{className:"bstn-hl-link bstn-related",href:e},Object(j.insertIf)(r,()=>h.Engine.createElement("img",ie({className:"bstn-hl-relatedthumb",src:r},i,{loading:"lazy"}))),h.Engine.createElement("span",{className:"bstn-hl-title gui-color-primary gui-color-hover bstn-related"},t))}var ae=n(145),ce=n.n(ae),le=n(9),ue=n.n(le),he=n(137),de=n(134),pe=h.Engine.createElement(he.VideoPlay,null)
